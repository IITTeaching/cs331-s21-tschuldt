...
class ArrayList:
    ...
    def __eq__(self, other):
        ...
        if (not isinstance(other,ArrayList) or len(self) != len(other)):
          return False
        for i in range(len(self.data)):
          if self.data[i] != other.__getitem__(i):
            return False
        return True
        ### END SOLUTION
    ...
    def min(self):
        ...
        low = self.data[0]
        for i in range(len(self.data)):
          if isinstance(self.data[i], int) and self.data[i] < low:
            low = self.data[i]
        return low
        ### END SOLUTION
    ...
    def max(self):
        ...
        high = self.data[0]
        for i in range(len(self.data)):
          if isinstance(self.data[i], int) and self.data[i] > high:
            high = self.data[i]
        return high
        ### END SOLUTION
    ...
    def __add__(self, other):
        ...
        for x in range(self.len):
          newa.append(self.data[x])
        for y in range(other.len):
          newa.append(other.data[y])
        return newa
        ### END SOLUTION
    ...
    def copy(self):
        ...
        arr = ArrayList(len(newa))
        arr.data = ConstrainedList.create(newa)
        return arr
        ### END SOLUTION
